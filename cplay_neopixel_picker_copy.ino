...
#define BRIGHTNESS              200 // NeoPixel brightness (0...255, low to max brightness)
...
void setup() {
  Serial.println("start met lezen bluefruit");
...
delay(100);
  ...
  if (packetbuffer[1] == 'C') {
    ...
    Serial.println("het commando c komt binnen");
    // servo motor ga naar links
    // 
